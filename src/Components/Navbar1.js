  ...
  return (
    <motion.div className="mafia__navbar" initial="initial" animate="animate">
      <motion.div className="mafia__navbar-links" variants={stagger}>
        <motion.div
          className="mafia__navbar-links_logo"
          variants={header}
        ...
        <motion.div
          className="mafia__navbar-links_container"
          variants={stagger}
        >
          <motion.p variants={header} whileHover={{ scale: 1.1 }}>
        ...
        {toggleMenu && (
          <div>
            <div className="mafia__navbar-menu_container scale-up-center">
              <motion.div
                className="mafia__navbar-menu_container-links"
                variants={stagger}
              >
                ...
                <motion.div
                  className="mafia__navbar-menu_container-links-sign"
                  variants={header}
                  whileHover={{ scale: 1.1 }}
                >
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (Cookies.get("user_email")) {
                        window.open(
                          `https://${window.location.hostname}/onboard`
                        );
                      } else {
                        setShowSign(true);
                      }
